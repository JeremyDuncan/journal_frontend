        ...
        <div className="flex-grow flex justify-center items-center relative">
            ...
            {isFilterModalOpen && (
                <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 overflow-y-auto">
                    <div ref={filterModalRef} className="flex-modal-container bg-gray-300 text-black rounded-lg shadow-lg">
                        <h2 className="text-2xl font-bold mb-2 text-center">Filter by Tags</h2>
                            <FiInfo
                        ...
                        <div className="modal-content mb-0 p-4 border rounded bg-gray-800 text-white relative">
            ...
            {isModalOpen && (
                <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 overflow-y-auto">
                    <div ref={modalRef} className="flex-modal-container bg-gray-300 text-black rounded-lg shadow-lg">
